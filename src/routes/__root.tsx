...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "VolSmart — Volunteer Services Platform" },
      { name: "description", content: "VolSmart by VolCop — volunteer management software for law enforcement and government agencies." },
      { name: "theme-color", content: "#0B2545" },
      { property: "og:title", content: "VolSmart — Volunteer Services Platform" },
      { name: "twitter:title", content: "VolSmart — Volunteer Services Platform" },
      { property: "og:description", content: "VolSmart by VolCop — volunteer management software for law enforcement and government agencies." },
      { name: "twitter:description", content: "VolSmart by VolCop — volunteer management software for law enforcement and government agencies." },
